...
const QuizPage = () => {
  ...
  const checkTeamLocked = async () => {
    ...
    try {
      const response = await fetch("http://ec2-13-239-119-91.ap-southeast-2.compute.amazonaws.com:3000/team-locked", {
        method: "POST",
        headers: {
  ...
  const fetchQuizData = async () => {
    try {
      ...
      const response = await fetch("http://ec2-13-239-119-91.ap-southeast-2.compute.amazonaws.com:3000/unsolved-questions", requestOptions);
      const data = await response.json();
      console.log(data);
  ...
  const fetchHints = async () => {
    try {
      const response = await fetch("http://ec2-13-239-119-91.ap-southeast-2.compute.amazonaws.com:3000/get-hints", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  useEffect(() => {
    const socket = new WebSocket("ws://ec2-13-239-119-91.ap-southeast-2.compute.amazonaws.com:8080");
  ...
  const validateAnswer = async (userAnswer: string) => {
    try {
      const response = await fetch("http://ec2-13-239-119-91.ap-southeast-2.compute.amazonaws.com:3000/submit-answer", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
